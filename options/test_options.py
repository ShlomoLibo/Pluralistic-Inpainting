...
class TestOptions(BaseOptions):
    def initialize(self,  parser):
        ...
        parser.add_argument('--results_dir', type=str, default='.', help='saves results here')
        ...
        parser.add_argument('--grid', type=bool, default=True, help='whether to output a grid of testing resutls')
